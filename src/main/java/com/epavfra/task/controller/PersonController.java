...
public class PersonController {
  ...
  @Operation(
      ...
      description = "Retrieves a list of persons. Optional filters can be applied using query parameters: sex, name, and surname. " +
      ...
      responses = {
          ...
          @ApiResponse(responseCode = "500", description = "Unexpected error - handled by global exception handler")
      }
  )
  @GetMapping
  public ResponseEntity<Collection<PersonDto>> getAllPersons(
      @Parameter(description = "Filter by sex", required = false)
  ...
  @Operation(
      ...
      description = "Retrieves a single person by their unique ID. " +
      ...
      responses = {
          ...
          @ApiResponse(responseCode = "404", description = "Person not found - handled by global exception handler"),
          @ApiResponse(responseCode = "500", description = "Unexpected error - handled by global exception handler")
      }
  )
  ...
  @Operation(
      ...
      responses = {
          ...
          @ApiResponse(responseCode = "400", description = "Validation failed - handled by global exception handler"),
          @ApiResponse(responseCode = "500", description = "Unexpected error - handled by global exception handler")
      }
  )
  @PostMapping
  ...
  @Operation(
      ...
      description = "Adds additional email addresses for the specified person and returns the updated person details. " +
      ...
      responses = {
          ...
          @ApiResponse(responseCode = "404", description = "Person not found - handled by global exception handler"),
          @ApiResponse(responseCode = "409", description = "Optimistic locking failure - handled by global exception handler"),
          @ApiResponse(responseCode = "500", description = "Unexpected error - handled by global exception handler")
      }
  )
  ...
  public ResponseEntity<PersonDto> addAdditionalEmailAddresses(
      ...
      @RequestBody Collection<String> emailAddresses) {
    try {
  ...
  @Operation(
      ...
      description = "Adds additional phone numbers for the specified person and returns the updated person details. " +
          "Validation errors (400), optimistic locking conflicts (409), or unexpected errors (500) are managed by the global exception handler.",
      responses = {
  ...
  public ResponseEntity<PersonDto> addAdditionalPhoneNumbers(
      ...
      @RequestBody Collection<String> phoneNumbers) {
    try {
